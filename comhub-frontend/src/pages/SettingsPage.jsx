...
export function SettingsPage({ user, token, selectedCommunity, userRoleInSelected, onProfileUpdated }) {
  ...
  const changeTheme = (newTheme) => {
    ...
    // Here we can apply a class to the body/html to change CSS variables globally
    // For simplicity, we just save it. A real app might update root style variables.
